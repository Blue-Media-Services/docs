...
<figure><img src="../../../es-419/.gitbook/assets/Captura de tela 2025-07-02 095105.png" alt=""><figcaption><p>Cookie Pools list</p></figcaption></figure>
...
1. Click on ![Create Cookie Pool](<../../../es-419/.gitbook/assets/image (42) (1).png>) to create a cookie pool.
2.  Fill in the details:\\

    <figure><img src="../../../es-419/.gitbook/assets/Captura de tela 2024-08-15 090606.png" alt=""><figcaption><p>Cookie Pool Editor</p></figcaption></figure>
...
3. Click on ![Save](<../../../es-419/.gitbook/assets/image (39) (1).png>) to save your Cookie Pool.

### Editing a Cookie Pool

After creating a cookie pool, you can edit it by clicking on the editing button <img src="../../../es-419/.gitbook/assets/image (89).png" alt="editing button" data-size="line">. All parameters are editable, for the TTL the changes will apply only to newly added cookies. After making your changes, click on ![Save](<../../../es-419/.gitbook/assets/image (39) (1).png>) to save them.

It's possible to archive cookie pools for your better organization. Click on ![](<../../../es-419/.gitbook/assets/image (96) (1).png>) to archive the selected cookie pool, visualize your archived cookie pools by turning on the switch "Archived" above the cookie pools list. It is also possible to unarchive a cookie pool by clicking on ![](<../../../es-419/.gitbook/assets/image (97) (2).png>).
...
You can delete a cookie pool by clicking on the delete button <img src="../../../es-419/.gitbook/assets/image (90).png" alt="delete button" data-size="original">, a warning that this action cannot be undone will be displayed to you, to proceed with the process click on ![Delete](<../../../es-419/.gitbook/assets/image (41) (1).png>) to confirm you are deleting it and it's done. Be aware that targets based on these cookie pools will stop working.
...
<figure><img src="../../../es-419/.gitbook/assets/image (92).png" alt=""><figcaption><p>Install Instructions Tab</p></figcaption></figure>

1. Select the cookie pool you will install by marking the checkbox next to its name.
2. On the Install Instructions tab, click on <img src="../../../es-419/.gitbook/assets/image (93).png" alt="" data-size="line"> to copy the code.
