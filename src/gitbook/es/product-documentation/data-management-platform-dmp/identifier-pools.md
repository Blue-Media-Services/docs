...
<figure><img src="../../../es-419/.gitbook/assets/image (470).png" alt=""><figcaption><p>Identifier Pools List</p></figcaption></figure>
...
1. Click on ![Create Identifier Pool](<../../../es-419/.gitbook/assets/image (475).png>) to create a new identifier pool.
2.  Fill in the details:

    <figure><img src="../../../es-419/.gitbook/assets/image (473).png" alt=""><figcaption><p>Identifier Pool Editor</p></figcaption></figure>
...
3. Click on ![Save](<../../../es-419/.gitbook/assets/image (476).png>) to save your Identifier Pool.

### Editing an Identifier Pool

After creating an identifier pool, you can edit it by clicking on the editing button ![Edit](<../../../es-419/.gitbook/assets/image (482).png>). All parameters are editable, for the TTL the changes will apply only to newly added identifiers. After making your changes, click on ![Save](<../../../es-419/.gitbook/assets/image (476).png>) to save them.

It's possible to archive identifier pools for your better organization. Click on ![Archive](<../../../es-419/.gitbook/assets/image (6) (2).png>) to archive the selected identifier pool, and visualize your archived identifier pools by turning on the switch "Archived" above the identifier pools list. It is also possible to unarchive an identifier pool by clicking on ![Unarchive](<../../../es-419/.gitbook/assets/image (7).png>).

### Deleting an Identifier Pool

You can delete an identifier pool by clicking on the delete button ![Delete](<../../../es-419/.gitbook/assets/image (8).png>), to proceed with the process click on ![Delete](<../../../es-419/.gitbook/assets/image (9).png>) to confirm. Be aware that tracker actions based on these identifier pools will stop working.
...
1. On the Configuration tab, in the events tracked section, click on ![Add Event](<../../../es-419/.gitbook/assets/image (485).png>) to add a new event.
2.  Fill in the details:\\

    <figure><img src="../../../es-419/.gitbook/assets/image (488).png" alt=""><figcaption><p>Event Editor</p></figcaption></figure>
    ...
    * Actions: Set actions to be executed when this event is requested, in this article, we will set an action that adds or removes identifiers from our identifiers pool.
      1. Click on ![Add Event](<../../../es-419/.gitbook/assets/image (485).png>) to add a new action.
      2.  Fill in the details:\\
      ...
      3. Click on ![Save](<../../../es-419/.gitbook/assets/image (476).png>) to save your action.
3. Click on ![Save](<../../../es-419/.gitbook/assets/image (476).png>) again to save your event.
