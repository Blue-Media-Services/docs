...
To create a catalog, click on <img src="../../../es-419/.gitbook/assets/image (41).png" alt="Create Catalog" data-size="line"> button.

<figure><img src="../../../es-419/.gitbook/assets/image (42).png" alt="" width="539"><figcaption><p>Create Catalog Screen</p></figcaption></figure>

Choose a **name** for your catalog, and if you wish, add **Tags** to better identify your catalog.

After filling in the fields, click on <img src="../../../es-419/.gitbook/assets/image (43).png" alt="Save" data-size="line">.

Then your catalog will be available on your list.

<figure><img src="../../../es-419/.gitbook/assets/image (44).png" alt=""><figcaption><p>Catalog List</p></figcaption></figure>

### Editing a Catalog

If you need to Edit a catalog's name or tags, click on <img src="../../../es-419/.gitbook/assets/image (45).png" alt="Edit" data-size="line">, after making the necessary changes, click on <img src="../../../es-419/.gitbook/assets/image (46).png" alt="Save" data-size="line">.

### Archiving a Catalog

To archive a catalog, click on <img src="../../../es-419/.gitbook/assets/image (47).png" alt="Archive" data-size="line">, then your archived catalog will be shown in the Archived list, to alter your view flip the toggle <img src="../../../es-419/.gitbook/assets/image (48).png" alt="Toggle" data-size="line">.

### Unarchiving a Catalog

To unarchive a catalog, toggle your view to the Archived list then click on <img src="../../../es-419/.gitbook/assets/image (49).png" alt="Unarchive" data-size="line">, and your catalog will return to the active catalogs.

### Deleting a Catalog

To delete a catalog, click on <img src="../../../es-419/.gitbook/assets/image (50).png" alt="Delete" data-size="line">, a screen will be shown to confirm the deletion.

<figure><img src="../../../es-419/.gitbook/assets/image (51).png" alt=""><figcaption><p>Catalog Deletion Screen</p></figcaption></figure>

After clicking on <img src="../../../es-419/.gitbook/assets/image (52).png" alt="Delete" data-size="line">, your catalog will be **permanently** deleted.
...
<figure><img src="../../../es-419/.gitbook/assets/image (105).png" alt=""><figcaption><p>Install Instructions Tab</p></figcaption></figure>
