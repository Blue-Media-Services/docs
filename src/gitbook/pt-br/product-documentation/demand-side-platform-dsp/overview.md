...
Você pode ter uma visão mais precisa de sua campanha verificando a aba <img src="../../.gitbook/assets/image (199).png" alt="Overview" data-size="line">. Aqui serão apresentadas as métricas mais valiosas de uma campanha, que podem ser divididas por **Públicos-alvo**, **Anúncios**, **Grupos de Criativos** e **Criativos**.
...
Após selecionar uma campanha e um período, você verá uma visão geral dessa campanha, incluindo todas os públicos-alvo, anúncios, grupos de criativos e criativos que estão impactando a campanha, e como eles estão performando.
...
{% hint style="info" %}
Alguns resultados podem aparecer como "não especificado" (_unspecified_) devido às configurações de privacidade do usuário ou à falta de dados de localização precisos. No entanto, os anúncios ainda são entregues dentro do público-alvo configurado. Por exemplo, se o público-alvo for para um país, os anúncios aparecerão apenas lá, mas os resultados por região ou cidade podem ser exibidos como "não especificado".
{% endhint %}
