# Verificar Classificação de URL
...
Para acessar nossa ferramenta de Verificar Classificação de URL, verifique o menu de ferramentas do DSP.

<figure><img src="../../.gitbook/assets/image (841).png" alt=""><figcaption><p>Acessando a Classificação de URL</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/image (662).png" alt=""><figcaption><p>Verificar Classificação de URL</p></figcaption></figure>
...
Ao sugerir uma nova classificação, clique no botão "**Sugerir Nova Classificação**". Uma tela aparecerá, permitindo que você proponha adicionar ou remover uma categoria.
