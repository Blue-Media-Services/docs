...
2.  Preencha as informações solicitadas nas 3 abas:\
    ...
    1.  Aba Geral
        ...
        * Quando remover produtos:&#x20;
          ...
          * Horas após ser importado: Defina quanto tempo após a importação os produtos devem permanecer no catálogo se não forem reimportados. Contanto que a frequência de importação seja menor que o tempo de expiração do produto, o catálogo não ficará vazio. Todas as métricas de produtos serão preservadas.
    2.  Aba Fonte\
        ...
        * Protocol: Selecione o protocolo de sua fonte e preencha os detalhes de acordo com sua escolha.
          1.  HTTP:
        ...
        *   Testar Fonte: Este botão, <img src="../../.gitbook/assets/image (991).png" alt="" data-size="line">, permite que você teste sua fonte e recupere dados relevantes para os próximos campos. Existem três abas para o resultado do teste da fonte:
            ...
            * Problemas: Exibe os problemas que podem afetar sua tarefa de importação.
            * _Raw_ (Bruto): Exibe o código-fonte do seu arquivo de _feed_.&#x20;
        ...
        * Conjunto de caracteres: Informe o conjunto de caracteres da fonte, que foi previamente detectado no resultado do teste.
    ...
    3.  Aba Mapeamento\
        ...
        *   Formato de modelo: Selecione entre estas duas opções:
            ...
            * Avançado: Para qualquer outro tipo de arquivo de _feed_, selecione esta opção.
            ...
            <figure><img src="../../.gitbook/assets/image (989).png" alt=""><figcaption><p>Aba Mapeamento - Avançado</p></figcaption></figure>
        * Detectar Modelo: Clique em <img src="../../.gitbook/assets/image (994).png" alt="" data-size="line">para detectar o melhor modelo com base no seu arquivo de _feed_.
        * Testar Modelo: Clique em <img src="../../.gitbook/assets/image (997).png" alt="" data-size="line"> para acessar uma pré-visualização de como seus produtos serão exibidos em seu catálogo. Se houver falhas no mapeamento ou no arquivo de _feed_, você as notará neste teste.
    ...
    4.  Aba Filtros\
        Nesta aba, você poderá definir filtros para selecionar os produtos que precisa importar. Isso pode ser útil para reduzir os custos das tarefas de importação, importando apenas os produtos que você precisa.
        ...
        * Após preencher os campos, você também precisará inserir os mesmos dados no modelo exibido. Você deve alterar apenas os valores que está filtrando, caso contrário, não funcionará corretamente.
...
A aba de métricas dos canais de importação contém dados sobre suas tarefas de importação, como processamento de dados, desempenho e taxa de falha. A aba exibirá dados de toda a conta para todos os canais se nenhum canal for selecionado. Selecionar um único canal mostrará métricas específicas para ele, enquanto selecionar múltiplos canais comparará seu desempenho. Estas são as métricas disponíveis:
