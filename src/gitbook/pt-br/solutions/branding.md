...
### Definindo um orçamento <a href="#defining-a-budget" id="defining-a-budget"></a>

Para sua campanha rodar, defina quanto deseja gastar diariamente. O sistema distribuirá as impressões ao longo do dia. No painel Configuração > Orçamento, insira o valor e salve.
...
Com um orçamento definido, especifique seu público-alvo. No painel Configuração > Público-alvo, clique em <img src="../.gitbook/assets/image (397).png" alt="Create Target" data-size="line">.&#x20;
...
* Conteúdo: Escolha em quais websites exibir seus anúncios com base no conteúdo do website, incluindo o idioma em que foi escrito, as categorias que identificam sobre o que ele trata, domínios específicos e palavras-chave presentes na URL.
...
Observe que quanto mais filtros você aplicar, mais específico seu público se tornará. Recomendamos que você experimente essas configurações até encontrar as opções de público-alvo certas que funcionam para sua campanha. Você pode clonar públicos-alvo existentes para facilitar a alteração de alguns aspectos e monitorar seus desempenhos.
...
* Entregas: O navegador do usuário final baixou seu anúncio do nosso Ad Server.
...
* Orçamento Gasto - indica como seu orçamento está sendo gasto ao longo do tempo.
...
* Exchange: Saiba como a ad exchange está se comportando e em qual vale a pena investir seu orçamento.

**Opções de visualização**

* Cartões de Métrica: Esta maneira é uma forma mais fácil de visualizar suas métricas e compará-las com outras, pois elas mostrarão um gráfico e apontarão para cada grupo escolhido.
...
Você também pode verificar suas métricas através da página Visão Geral. Você pode acessá-la através da Pagina inicial ou da página Campanhas, basta clicar em <img src="../.gitbook/assets/image (43).png" alt="" data-size="line">, lá você pode escolher uma campanha e ver suas métricas em uma visão mais ampla.
