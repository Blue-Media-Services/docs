...
2. Haga clic en <img src="../.gitbook/assets/image (423).png" alt="Create Catalog Button" data-size="line"> para crear un nuevo catálogo.
...
2. Haga clic en <img src="../.gitbook/assets/image (424).png" alt="+ import channel button" data-size="line"> para comenzar.
...
2. Haga clic en <img src="../.gitbook/assets/image (425).png" alt="Start Button" data-size="line"> para iniciar una importación manual.
...
6. Haga clic en <img src="../.gitbook/assets/image (426).png" alt="Start Button" data-size="line"> para iniciar.
...
2. Haga clic en <img src="../.gitbook/assets/image (427) (1).png" alt="+ tracker button" data-size="line"> para agregar un nuevo tracker.
...
2. En la pestaña de configuración, haz clic en <img src="../.gitbook/assets/image (428) (1).png" alt="Add button" data-size="line"> para crear un evento.
...
5. Haz clic en <img src="../.gitbook/assets/image (428) (1).png" alt="Add button" data-size="line"> para crear una acción que se ejecutará después de que el evento haya sido rastreado.
...
8. Haz clic en <img src="../.gitbook/assets/image (50) (1).png" alt="Save button" data-size="line"> para guardar la acción creada.
9. Puedes añadir más acciones a este evento y luego hacer clic nuevamente en <img src="../.gitbook/assets/image (50) (1).png" alt="Save button" data-size="line"> para guardar el evento completo.
...
4. Si configuraste campos de datos personalizados, usa los placeholders indicados para informar los valores.\
   Aquí tienes un ejemplo de cómo podría verse el placeholder indicado para tus campos de datos personalizados: <img src="../.gitbook/assets/image (432) (1).png" alt="Custom data field example" data-size="original">.\
...
5. Haz clic en <img src="../.gitbook/assets/image (434).png" alt="copy button" data-size="line"> para copiar el script.
...
3. Haz clic en <img src="../.gitbook/assets/image (434).png" alt="copy button" data-size="line"> para copiar la etiqueta Pixel.
...
4. Haz clic en <img src="../.gitbook/assets/image (434).png" alt="copy button" data-size="line"> para copiar la URL generada y úsala como la URL proporcionada anteriormente.
...
2. Haz clic en <img src="../.gitbook/assets/image (435).png" alt="Create recommendation model button" data-size="line"> para crear un nuevo modelo de recomendación.
3. Asigna un Nombre y Etiquetas.
4. Selecciona el catálogo del cual el modelo recopilará datos e interacciones de los leads.
5. Haz clic en <img src="../.gitbook/assets/image (50) (1).png" alt="save button" data-size="line">para guardar los cambios.
...
* Rastreadores DMP
  ...
  9. Haz clic en <img src="../.gitbook/assets/image (50) (1).png" alt="save button" data-size="line"> para guardar los cambios.
...
* **Creando un modelo de blueprint**
  ...
  2. Haz clic en <img src="../.gitbook/assets/image (388).png" alt="add blueprint button" data-size="line">.
...
2. Haz clic en <img src="../.gitbook/assets/image (447).png" alt="create build button" data-size="line"> para comenzar a crear un nuevo build.
...
9. Marca la casilla "Enviar creativos para aprobación" y haz clic en <img src="../.gitbook/assets/image (448).png" alt="" data-size="line"> para guardar tu build y enviarlo a revisión de los Ad Exchanges.
...
2. Haz clic en <img src="../.gitbook/assets/image (449).png" alt="add creative build button" data-size="line"> para crear un nuevo grupo creativo.
3. Asigna un Nombre y Etiquetas.
4. Selecciona tu dominio.
5. Selecciona el formato de los creativos en el grupo.
6. Selecciona los creativos que deberían formar parte de este grupo. Haz clic en <img src="../.gitbook/assets/image (66) (1).png" alt="Add button" data-size="line"> para agregar más campos y seleccionar tus creativos.
...
9. Haz clic en <img src="../.gitbook/assets/image (448).png" alt="" data-size="line"> para guardar los cambios.
...
2. Haz clic en <img src="../.gitbook/assets/image (68) (1).png" alt="create add button" data-size="line"> para crear tu anuncio.
3. Asigna un Nombre y Etiquetas.
4. Selecciona tu dominio.
...
9. Haz clic en <img src="../.gitbook/assets/image (448).png" alt="" data-size="line"> para guardar tu anuncio.
...
5. Haz clic en <img src="../.gitbook/assets/image (440).png" alt="" data-size="line"> para agregar las imágenes de tus creativos según las siguientes opciones:
   * Usar Existentes
     1. Selecciona todas las imágenes que quieras entre las que ya has subido a la plataforma.
     2. Haz clic en <img src="../.gitbook/assets/image (441).png" alt="" data-size="line"> para confirmar tu selección.
   * Subir Nuevas
     1. Sube nuevas imágenes arrastrándolas a la caja o haciendo clic en <img src="../.gitbook/assets/image (442).png" alt="" data-size="line"> y seleccionándolas desde tu dispositivo.
     2. Haz clic en <img src="../.gitbook/assets/image (441).png" alt="" data-size="line"> para confirmar.
...
8. Haz clic en <img src="../.gitbook/assets/image (443).png" alt="" data-size="line"> para guardar tus anuncios y enviarlos a revisión.
...
2. En la pestaña Rules, haz clic en <img src="../.gitbook/assets/image (444).png" alt="" data-size="line"> para agregar una nueva regla.
3. Asigna un Nombre y selecciona qué Grupo Creativo debe verse afectado.
4. Activa la opción de Programación cambiando el interruptor a “on” <img src="../.gitbook/assets/image (445).png" alt="" data-size="original"> .
...
6. Haz clic en <img src="../.gitbook/assets/image (446).png" alt="" data-size="line"> para guardar tu regla.
