...
<figure><img src="../.gitbook/assets/image (1110).png" alt=""><figcaption><p>Looker Studio Homepage</p></figcaption></figure>
...
5.  Search for "BMS" in the search bar.\\
    ...
    <figure><img src="../.gitbook/assets/image (1111).png" alt=""><figcaption><p>Finding BMS Connector</p></figcaption></figure>
6. Click on the BMS Monitoring to select it as a data source.
7.  Fill in with the correct parameters:\\

    <figure><img src="../.gitbook/assets/image (1112).png" alt=""><figcaption><p>BMS Connector Parameters</p></figcaption></figure>
