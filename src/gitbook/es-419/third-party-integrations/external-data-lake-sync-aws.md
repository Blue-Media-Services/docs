...
<figure><img src="../../es-419/.gitbook/assets/image (1123).png" alt=""><figcaption><p>Template with VPC</p></figcaption></figure>
...
* Event Store ID: Inform the Event Store ID, you can find it by clicking on <img src="../../es-419/.gitbook/assets/image (1121).png" alt="edit" data-size="line"> at the same row as the event store you wish to import.
...
<figure><img src="../../es-419/.gitbook/assets/image (1124).png" alt=""><figcaption><p>Template without VPC</p></figcaption></figure>
...
* [Event Pipes](../../es-419/product-documentation/monitoring/event-pipes.md)
* [Event Stores](../../es-419/product-documentation/monitoring/event-stores.md)
