...
Click on ![create blueprint](<../../../.gitbook/assets/image (803).png>) to start creating your blueprint.

<figure><img src="../../../.gitbook/assets/image (800).png" alt=""><figcaption><p>Blueprint Creation</p></figcaption></figure>
...
1. Fill in the Details:
   ...
   *   Parameters: Click on ![](<../../../.gitbook/assets/image (69) (2).png>) to create a new parameters group.\\

       <figure><img src="../../../.gitbook/assets/image (327).png" alt=""><figcaption><p>Parameters Group Creator</p></figcaption></figure>

       * Name: Set a name for this parameters group.
       * Description: Set a description of the parameters group.
       * Click on ![save](<../../../.gitbook/assets/image (806).png>) to save your parameter group.
2.  After creating the parameters group, you can begin coding your banner on the code box. Then, configure the parameters of your code to align with those in the parameter group. To add a new parameter to the group click on ![](<../../../.gitbook/assets/image (224).png>) and fill in the details:

    <figure><img src="../../../.gitbook/assets/image (249).png" alt=""><figcaption><p>Parameter Creator - Type Options</p></figcaption></figure>
    ...
    * Type: Select the data type of the input:
      *   **String**
          ...
          <figure><img src="../../../.gitbook/assets/image (328).png" alt=""><figcaption><p>Parameter Editor - String Type</p></figcaption></figure>
      ...
      *   **Boolean**
          ...
          <figure><img src="../../../.gitbook/assets/image (247).png" alt=""><figcaption><p>Parameter Editor - Boolean Type</p></figcaption></figure>

          * Initial Value: Check the box if the initial value is true, uncheck it if it's false.
      *   **Choice**

          <figure><img src="../../../.gitbook/assets/image (248).png" alt=""><figcaption><p>Parameter Editor - Choice Type</p></figcaption></figure>

          * Label: Insert the label of your parameter.
          * Value: Insert the value associated with the label.
          * Add as many labels as you need by clicking on ![Add](<../../../.gitbook/assets/image (805).png>).
          * Initial Value: Pick one of the configurated labels as the initial value.
      *   **Code**

          <figure><img src="../../../.gitbook/assets/image (250).png" alt=""><figcaption><p>Parameter Editor - Code Type</p></figcaption></figure>

          * Type: Select the code language.
          * Code box: Insert your code into the code box.
      *   **Color**

          <figure><img src="../../../.gitbook/assets/image (244).png" alt=""><figcaption><p>Parameter Editor - Color Type</p></figcaption></figure>

          * Initial Value: Insert the hex color code, or click on the color box to pick a color.
      *   **Number**

          <figure><img src="../../../.gitbook/assets/image (246).png" alt=""><figcaption><p>Parameter Editor - Number Type</p></figcaption></figure>
      ...
      *   **Resource ID**
          ...
          <figure><img src="../../../.gitbook/assets/image (245).png" alt=""><figcaption><p>Parameter Editor - Resource ID type</p></figcaption></figure>
      ...
      *   **URL**
          ...
          <figure><img src="../../../.gitbook/assets/image (329).png" alt=""><figcaption><p>Parameter Editor - URL Type</p></figcaption></figure>
    ...
    * Click on ![save](<../../../.gitbook/assets/image (806).png>) to save your parameter.
...
6. After finishing all your blueprint settings, click on <img src="../../../.gitbook/assets/image (9) (1).png" alt="" data-size="line"> to save your blueprint.

### Using an Existing Blueprint

It's possible to use an existing blueprint as well. You can duplicate a blueprint you already have to reuse some of its parameters by clicking on <img src="../../../.gitbook/assets/image (227).png" alt="" data-size="line"> at the same row as the blueprint you want to be duplicated. Additionally, you can use a public blueprint. Turn off the <img src="../../../.gitbook/assets/image (228).png" alt="" data-size="line"> owned option, above the blueprints list, choose one of the available blueprints, and click on <img src="../../../.gitbook/assets/image (227).png" alt="" data-size="line"> at the same row as the public blueprint you want to use. Turn on ![](<../../../.gitbook/assets/image (230).png>)the owned option again, and then click on <img src="../../../.gitbook/assets/image (232).png" alt="" data-size="line"> to edit the blueprint according to your business needs.

### Deleting Blueprints

You can delete or archive blueprints according to your needs. To archive blueprints, click on ![](<../../../.gitbook/assets/image (233).png>) at the same row as the blueprint you want to archive. To view your archived blueprints, turn on the ![](<../../../.gitbook/assets/image (230).png>) archived option above the list of blueprints.
...
To delete blueprints click on ![](<../../../.gitbook/assets/image (321).png>) at the same row as the blueprint you need to delete, then confirm the action by clicking on <img src="../../../.gitbook/assets/image (236).png" alt="" data-size="line">.
