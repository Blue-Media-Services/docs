...
1. Fill in the Details:
   ...
   *   Parameters: Click on ![](<../../../.gitbook/assets/image (222).png>) to create a new parameters group.\


       <figure><img src="../../../.gitbook/assets/image (241).png" alt=""><figcaption><p>Parameters Group Creator</p></figcaption></figure>
...
2.  After creating the parameters group, you can begin coding your banner on the code box. Then, configure the parameters of your code to align with those in the parameter group. To add a new parameter to the group click on ![](<../../../.gitbook/assets/image (224).png>) and fill in the details:
    ...
    * Type: Select the data type of the input:
      *   **String**
          ...
          <figure><img src="../../../.gitbook/assets/image (242).png" alt=""><figcaption><p>Parameter Editor - String Type</p></figcaption></figure>
      ...
      *   **URL**
          ...
          <figure><img src="../../../.gitbook/assets/image (243).png" alt=""><figcaption><p>Parameter Editor - URL Type</p></figcaption></figure>
...
To delete blueprints click on ![](<../../../.gitbook/assets/image (235).png>) at the same row as the blueprint you need to delete, then confirm the action by clicking on <img src="../../../.gitbook/assets/image (236).png" alt="" data-size="line">.
