...
<figure><img src="../../../.gitbook/assets/image (216).png" alt=""><figcaption><p>Creatives Tab</p></figcaption></figure>
...
You can also duplicate builds by clicking on <img src="../../../.gitbook/assets/image (218).png" alt="" data-size="line"> at the same row as the build you need to duplicate. This is useful if you want to create a build that changes only a few details compared to an existing one while keeping the original.
