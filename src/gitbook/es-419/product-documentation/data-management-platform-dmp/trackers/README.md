...
1. Click on <img src="../../../.gitbook/assets/image (92) (1).png" alt="" data-size="line"> to start creating a tracker.
2.  Fill in the details:

    <figure><img src="../../../.gitbook/assets/image (1120).png" alt=""><figcaption><p>Tracker Editor</p></figcaption></figure>
...
3. Click on <img src="../../../.gitbook/assets/image (93) (1).png" alt="" data-size="line"> to save your tracker.

### Editing a Tracker

All the trackers' parameters are editable, click on ![](<../../../.gitbook/assets/image (95) (1).png>) in the same row of the tracker you want to edit, make your changes, and then click on ![Save](<../../../.gitbook/assets/image (39) (1).png>) to save them.
...
<figure><img src="../../../.gitbook/assets/image (1).png" alt=""><figcaption><p>Trackers' Configuration Tab</p></figcaption></figure>
...
1. On the Configuration tab, click on <img src="../../../.gitbook/assets/image (364).png" alt="" data-size="original"> to start creating an event.
2. Fill in the details:
...
1. Click on ![](<../../../.gitbook/assets/image (364).png>) to add an action to your event, the action is what your tracker will do at BMS once the user access the designed page or perform the specified action.
2. Fill in the details:
...
3. Click on <img src="../../../.gitbook/assets/image (93) (1).png" alt="" data-size="line"> to save your action.
4. Feel free to add more actions to this event, and when you're done, click on <img src="../../../.gitbook/assets/image (93) (1).png" alt="" data-size="line"> to save your event.

### Editing Events and Actions

Edit your events and actions to meet your business needs.

We can edit events by clicking on ![](<../../../.gitbook/assets/image (95) (1).png>) at the same row of the event to be edited on the Configuration tab, all events' parameters are available to be edited, after finishing your changes, click on ![Save](<../../../.gitbook/assets/image (39) (1).png>) to save them.

Actions' parameters are also editable, you can do this by finding the event that contains the action you want to edit on the Configuration tab, clicking on ![](<../../../.gitbook/assets/image (95) (1).png>) at the same row of the event, and then clicking on ![](<../../../.gitbook/assets/image (95) (1).png>) at the same row of the action to be edited, make your changes and click on ![Save](<../../../.gitbook/assets/image (39) (1).png>) to save your changes, then click on ![Save](<../../../.gitbook/assets/image (39) (1).png>) again to save your changes to the event, and you're done.
