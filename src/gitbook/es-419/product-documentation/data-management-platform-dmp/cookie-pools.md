...
1. Click on ![Create Cookie Pool](<../../.gitbook/assets/image (42) (1).png>) to create a cookie pool.
...
3. Click on ![Save](<../../.gitbook/assets/image (39) (1).png>) to save your Cookie Pool.
...
<figure><img src="../../.gitbook/assets/image (92).png" alt=""><figcaption><p>Install Instructions Tab</p></figcaption></figure>

1. Select the cookie pool you will install by marking the checkbox next to its name.
2. On the Install Instructions tab, click on <img src="../../.gitbook/assets/image (93).png" alt="" data-size="line"> to copy the code.
