...
<figure><img src="../../../.gitbook/assets/Captura de tela 2024-12-05 072802 (1).png" alt=""><figcaption><p>Blueprints List</p></figcaption></figure>
...
Click on ![create blueprint](<../../../.gitbook/assets/image (405) (1).png>) to start creating your blueprint.

<figure><img src="../../../.gitbook/assets/image (402) (2).png" alt=""><figcaption><p>Blueprint Creation</p></figcaption></figure>
...
1. Fill in the Details:
   ...
   *   Parameters: Click on ![](<../../../.gitbook/assets/image (1) (10).png>) to create a new parameters group.\\
       ...
       * Click on ![save](<../../../.gitbook/assets/image (408) (1).png>) to save your parameter group.
2.  After creating the parameters group, you can begin coding your banner on the code box. Then, configure the parameters of your code to align with those in the parameter group. To add a new parameter to the group click on ![](<../../../.gitbook/assets/image (3) (7).png>) and fill in the details:
    ...
    * Type: Select the data type of the input:
      ...
      *   **Choice**
          ...
          * Add as many labels as you need by clicking on ![Add](<../../../.gitbook/assets/image (407) (1).png>).
    ...
    * Click on ![save](<../../../.gitbook/assets/image (408) (1).png>) to save your parameter.
