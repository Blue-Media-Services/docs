...
The metrics displayed on the Metrics tab of the Builds page are the same as those on the Creatives page. To understand how they work and what each one means, please check our [Creatives Metrics Tab](../../ad-serving/creatives.md#metrics-tab) page.
